...
| 新機能のまとめ体験 | `feature_combo_demo` の 3 PDF | 帳票ヘッダー出力、2ページ結合、ヘッダー位置ずれ吸収を 1 回で試せる | `Result`, `Review` |
...
### 4-4. 新機能 3 ファイル同時取り込みパターン

1. `[1] PDFファイルを選んで変換` を選びます。
2. 次の 3 ファイルを同時に選びます。
   - [2026年07月_作業員勤怠一覧_新機能体験_標準帳票.pdf](../../samples/v2/pdf/feature_combo_demo/2026年07月_作業員勤怠一覧_新機能体験_標準帳票.pdf)
   - [2026年07月_作業員勤怠一覧_新機能体験_2ページ帳票.pdf](../../samples/v2/pdf/feature_combo_demo/2026年07月_作業員勤怠一覧_新機能体験_2ページ帳票.pdf)
   - [2026年07月_作業員勤怠一覧_新機能体験_ヘッダー位置ずれ帳票.pdf](../../samples/v2/pdf/feature_combo_demo/2026年07月_作業員勤怠一覧_新機能体験_ヘッダー位置ずれ帳票.pdf)
3. 保存先を `output\v2_sample_feature_combo.xlsx` などで指定します。
4. 実行後に `Result` と `Review` を確認します。

確認ポイント:

- `Result` の列名が `項目1..N` ではなく、帳票ヘッダー由来の名前になっていること
- 2ページ帳票が 1 つのファイルとして連結され、同時投入でも分断されないこと
- ヘッダー位置ずれ帳票が `Result` に入りつつ、`Review` に `HEADER_ROW_SHIFT` が出ること
- 3 ファイル同時取込でも、列順はプロファイル定義順で揃うこと
